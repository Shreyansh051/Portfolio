...
const Contact = () => {
  ...
  return (
    <>
      ...
      >
        <h1
          className={`${styles.top} pr-lg-5 pr-xs-3 text-boldest mb-0 color-customBlue`}
        ...
        <div className="mt-3 mb-3 pr-lg-5 pr-xs-3">
          <button className={` ${styles.contactbtn} contact-btns  mr-2 shadow border-0 py-1`}>
            <FontAwesomeIcon size="1x" icon={faPhone} />
            <span>8435093856</span>
          </button>

          <button
            className={` ${styles.contactbtn} contact-btns  mr-2 shadow border-0 py-1`}
            onClick={() =>
              window.open("https://www.linkedin.com/in/shreyansh-21b181215/", "_blank")
            }
          >
          ...
          <button
            className={` ${styles.contactbtn} contact-btns  mr-2 shadow border-0 py-1`}
            onClick={() =>
              window.open("https://github.com/Shreyansh051", "_blank")
            }
          >
          ...
          <button
            ...
            onClick={() =>
              window.open(
                'mailto:shreyanshgupta148@gmail.com?subject="Hello !"',
                "_blank"
              )
            }
          >
